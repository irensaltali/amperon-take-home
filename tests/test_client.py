...
class TestSuccessfulAPICalls:
    ...
    def test_fetch_weather_success(self, client, sample_location, mock_weather_response):
...
class TestBatchFetching:
    ...
    def test_fetch_multiple_locations_partial_failure(self, client, mock_weather_response):
