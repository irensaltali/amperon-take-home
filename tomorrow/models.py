...
class TimelineValues(BaseModel):
    ...
    temperature: Optional[float] = Field(
        None, alias="temperature", description="Temperature in Celsius"
    )
    temperature_apparent: Optional[float] = Field(
        None,
        alias="temperatureApparent",
        description="Feels-like temperature in Celsius",
    )

    # Wind fields
    wind_speed: Optional[float] = Field(
        None, alias="windSpeed", description="Wind speed in m/s"
    )
    wind_gust: Optional[float] = Field(
        None, alias="windGust", description="Wind gust speed in m/s"
    )
    wind_direction: Optional[int] = Field(
        None, alias="windDirection", description="Wind direction in degrees (0-360)"
    )

    # Atmospheric conditions
    humidity: Optional[float] = Field(
        None, alias="humidity", description="Relative humidity as percentage (0-100)"
    )
    dew_point: Optional[float] = Field(
        None, alias="dewPoint", description="Dew point in Celsius"
    )
    cloud_cover: Optional[float] = Field(
        None, alias="cloudCover", description="Cloud cover as percentage (0-100)"
    )
    cloud_base: Optional[float] = Field(
        None, alias="cloudBase", description="Cloud base height in km"
    )
    cloud_ceiling: Optional[float] = Field(
        None, alias="cloudCeiling", description="Cloud ceiling height in km"
    )
    visibility: Optional[float] = Field(
        None, alias="visibility", description="Visibility in km"
    )
    ...
    rain_intensity: Optional[float] = Field(
        None, alias="rainIntensity", description="Rain intensity in mm/hr"
    )
    rain_accumulation: Optional[float] = Field(
        None, alias="rainAccumulation", description="Rain accumulation in mm"
    )
    freezing_rain_intensity: Optional[float] = Field(
        None,
        alias="freezingRainIntensity",
        description="Freezing rain intensity in mm/hr",
    )
    sleet_intensity: Optional[float] = Field(
        None, alias="sleetIntensity", description="Sleet intensity in mm/hr"
    )
    sleet_accumulation: Optional[float] = Field(
        None, alias="sleetAccumulation", description="Sleet accumulation in mm"
    )
    sleet_accumulation_lwe: Optional[float] = Field(
        None,
        alias="sleetAccumulationLwe",
        description="Sleet accumulation liquid water equivalent in mm",
    )
    snow_intensity: Optional[float] = Field(
        None, alias="snowIntensity", description="Snow intensity in mm/hr"
    )
    snow_accumulation: Optional[float] = Field(
        None, alias="snowAccumulation", description="Snow accumulation in mm"
    )
    snow_accumulation_lwe: Optional[float] = Field(
        None,
        alias="snowAccumulationLwe",
        description="Snow accumulation liquid water equivalent in mm",
    )
    snow_depth: Optional[float] = Field(
        None, alias="snowDepth", description="Snow depth in cm"
    )
    ice_accumulation: Optional[float] = Field(
        None, alias="iceAccumulation", description="Ice accumulation in mm"
    )
    ice_accumulation_lwe: Optional[float] = Field(
        None,
        alias="iceAccumulationLwe",
        description="Ice accumulation liquid water equivalent in mm",
    )
    evapotranspiration: Optional[float] = Field(
        None, alias="evapotranspiration", description="Evapotranspiration in mm"
    )

    # Pressure fields
    pressure_sea_level: Optional[float] = Field(
        None, alias="pressureSeaLevel", description="Sea level pressure in hPa"
    )
    pressure_surface_level: Optional[float] = Field(
        None, alias="pressureSurfaceLevel", description="Surface level pressure in hPa"
    )
    altimeter_setting: Optional[float] = Field(
        None, alias="altimeterSetting", description="Altimeter setting in hPa"
    )

    # Weather codes
    weather_code: Optional[int] = Field(
        None, alias="weatherCode", description="Tomorrow.io weather condition code"
    )

    # UV index
    uv_index: Optional[int] = Field(
        None, alias="uvIndex", description="UV index (0-11+)"
    )
    uv_health_concern: Optional[int] = Field(
        None, alias="uvHealthConcern", description="UV health concern level (0-5)"
    )
...
class TimelineEntry(BaseModel):
    ...
    time: datetime = Field(
        ..., alias="time", description="Timestamp of the weather reading (ISO 8601)"
    )
    values: TimelineValues = Field(
        ..., alias="values", description="Weather values for this timestamp"
    )
...
class Location(BaseModel):
    ...
    is_active: bool = Field(
        True, description="Whether this location is active for data collection"
    )
    created_at: Optional[datetime] = Field(
        None, description="When the location was added"
    )
...
class WeatherReading(BaseModel):
    ...
    humidity: Optional[float] = Field(
        None, description="Relative humidity as percentage"
    )
    precipitation_probability: Optional[float] = Field(
        None, description="Precipitation probability as percentage"
    )
    weather_code: Optional[int] = Field(
        None, description="Tomorrow.io weather condition code"
    )
    ...
    pressure_surface_level: Optional[float] = Field(
        None, description="Surface level pressure in hPa"
    )
